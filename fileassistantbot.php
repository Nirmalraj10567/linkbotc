...
define('FILES_EXPIRE_TIME', 2400000000000000000000000000000000* 3600); // in seconds
    ...
    public function onUpdateNewMessage($update)
    {
        ...
        try {
            if (isset($update['message']['media']) && ($update['message']['media']['_'] == 'messageMediaPhoto' || $update['message']['media']['_'] == 'messageMediaDocument')) {
                ...
                if ($text == '/start') {
                    yield $this->messages->sendMessage(['peer' => $update, 'message' => 'Hi! welcome to infinitrocyber subscribe my channel https://www.youtube.com/channel/UCLHZQApnu1vN2j7fKDgv74w', 'reply_to_msg_id' => $message_id]);
